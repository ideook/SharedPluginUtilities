...
nHistoryID: nHistoryID,
    ...
    bFaces: bFaces
        ...
        WSM.APIRayFireSortedReadOnly = function(nHistoryID,line3dPickRay,dRayRadius,bVertices,bEdges,bFaces,dMaxParam,bSearchInGroups,aIgnoreObjects) {
            const args = {
...
nHistoryID: nHistoryID,
    ...
    aIgnoreObjects: aIgnoreObjects
        ...
        WSM.APIIntersectsNegativeSideOfPlanesReadOnly = function(nHistoryID,aPlanes,dTol,bVertices,bEdges,bFaces,bStrict,line3dPickRay,bSearchInGroups,bPickInstances,aIgnoreObjects) {
            const args = {
...
nHistoryID: nHistoryID,
        ...
        WSM.Utils.IsOwnerOf = function(parent,child) {
            const args = {
...
nFromHistoryID: nFromHistoryID,
        ...
        WSM.Atf.APILoadWithATF = function(nHistoryID,sFilePath,eFileType,nOptions) {
            const args = {
...
bTouchEnabled: bTouchEnabled
        ...
        FormIt.ImportFile = function(sFileName,bGroupImport,nHistoryID,bKeepLevelsWhenGrouping) {
            const args = {
...
show: show
        ...
        FormIt.FindLatestVersion = function(versionJsonString,testVersion) {
            const args = {
...
funcName: funcName,
    paramsJSON: paramsJSON
        ...
        FormIt.SetLocaleForWeb = function(nameCode) {
            const args = {
...
nameCode: nameCode
        ...
        FormIt.ConsoleLog = function(msg) {
            const args = {
...
layerID: layerID,
        ...
        FormIt.Layers.SetLoadInRevit = function(layerID,load) {
            const args = {
...
afterSceneName: afterSceneName
        ...
        FormIt.Scenes.AddNewSceneToAnimation = function(animationName) {
            const args = {
...
oldPos: oldPos,
        ...
        FormIt.Scenes.GetNumberOfScenesWithAnimation = function(animationName) {
            const args = {
                TestAPI: "FormIt.Scenes.GetNumberOfScenesWithAnimation",
animationName: animationName
            };
...
sceneName: sceneName
        ...
        FormIt.Scenes.SetEditCameras = function(bEditCameras,animationName,sceneName) {
            const args = {
...
bEditCameras: bEditCameras,
        ...
        FormIt.Scenes.AddSceneAnimation = function() {
            const args = {
        ...
        FormIt.Scenes.RemoveAnimation = function(animationName) {
            const args = {
...
animationName: animationName
        ...
        FormIt.Scenes.GetSceneAnimations = function() {
            const args = {
        ...
        FormIt.Scenes.GetSceneAnimation = function(animationName) {
            const args = {
...
animationName: animationName
        ...
        FormIt.Scenes.GetSceneNamesFromAnimation = function(animationName) {
            const args = {
...
animationName: animationName
        ...
        FormIt.Scenes.AddScenesToAnimation = function(animationName,sceneNames,sceneBeforeOrAfterName,insertAfter) {
            const args = {
...
animationName: animationName,
        ...
        FormIt.Scenes.RearrangeAnimations = function(animationNames,animationBeforeOrAfterName,insertAfter) {
            const args = {
...
animationNames: animationNames,
        ...
        FormIt.Scenes.IsValidAnimationName = function(oldName,newName) {
            const args = {
...
oldName: oldName,
        ...
        FormIt.Scenes.SetAnimationName = function(oldName,newName) {
            const args = {
...
oldName: oldName,
        ...
        FormIt.Scenes.GetAnimationLoop = function(animationName) {
            const args = {
...
animationName: animationName
        ...
        FormIt.Scenes.SetAnimationLoop = function(animationName,loop) {
            const args = {
...
animationName: animationName,
        ...
        FormIt.Scenes.GetAnimationCollapsed = function(animationName) {
            const args = {
...
animationName: animationName
        ...
        FormIt.Scenes.SetAnimationCollapsed = function(animationName,collapsed) {
            const args = {
...
animationName: animationName,
        ...
        FormIt.Scenes.StartStopAnimation = function(start,animationName,fromScene) {
            const args = {
...
start: start,
        ...
        FormIt.Scenes.GetAnimationForScene = function(sceneName) {
            const args = {
...
materialID: materialID,
        ...
        FormIt.SketchMaterials.RearrangeMaterials = function(materialIds,materialBeforeOrAfterId,insertAfter) {
            const args = {
...
FormIt.View = {};
        ...
        FormIt.View.FitToModel = function(aIncludeImage,withTransition) {
            const args = {
...
aIncludeImage: aIncludeImage,
        ...
        FormIt.View.FitToSelection = function(withTransition) {
            const args = {
...
withTransition: withTransition
        ...
        FormIt.View.HomeView3d = function(withTransition) {
            const args = {
...
withTransition: withTransition
        ...
        FormIt.View.SetViewDirection = function(type) {
            const args = {
...
type: type
        ...
        FormIt.View.GetViewDirection = function() {
            const args = {
...
color: color
        ...
        FormIt.VisualStyles.SetGroundPlaneTransparency = function(trans) {
            const args = {
...
trans: trans
        ...
        FormIt.VisualStyles.GetGroundPlaneTransparency = function() {
            const args = {
